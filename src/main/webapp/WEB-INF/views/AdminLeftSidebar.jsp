      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="hackathonMenu">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="addHackathon">Add Hackathon</a></li>
                <li class="nav-item"> <a class="nav-link" href="listHackathon">List Hackathon</a></li>
              </ul>
            </div>
          </li>
