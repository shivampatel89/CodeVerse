...
<head>
  ...
  <title>CodeVerse | Reset Password</title>
...
<body>
  <div class="auth-shell">
    <div class="auth-panel">
      <div class="hero-card">
        <div>
          <div class="hero-title">Set a new <span>password</span>.</div>
          <p class="hero-copy">OTP verify karne ke baad apna new password set karo aur account regain karo.</p>
          <div>
            <span class="pill">Secure update</span>
            <span class="pill">Quick access</span>
      ...
      <div class="form-card">
        <div class="w-100">
          ...
          <p class="mb-4 text-secondary">Enter a strong new password for your account.</p>
          <form action="/changePassword" method="post">
            ...
            <div class="text-center mt-3"><a href="/login" class="text-link">← Back</a></div>
          </form>
